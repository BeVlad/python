...
class OfficeEquipment:
    ...
    def __init__(
        ...
        self.printable = True if self.type in ("printer", "samsung") else False
        self.scannable = True if self.type in ("scanner", "samsung") else False
